...
<body class="flex flex-col min-h-[100vh]">
    <header class="bg-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="py-6">
                <p class="text-white text-xl">Todo List</p>
            </div>
        </div>
    </header>
    ...
    <main class="grow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="py-[100px]">
                <form action="<?php echo e(route('store')); ?>" method="post" class="mt-10">
                  <?php echo csrf_field(); ?>
                              ...
                              <tr>
                                  ...
                                  <td class="p-0 text-right text-sm font-medium">
                                      <div class="flex justify-end">
                                          <div>
                                              <form action="<?php echo e(route('complete', ['id' => $item->id])); ?>"
                                                  method="post"
                                          ...
                                          <div>
                                              ...
                                              <button type="submit" class="py-4 w-20 md:hover:bg-slate-200 transition-colors">編集
                                              </a>
                                              </button>
                                          </div>
                                          <div>
                                              <form onsubmit="return deleteTask();"
                                                  action="<?php echo e(route('delete', ['id' => $item->id])); ?>" method="post"
                                                  class="inline-block text-gray-500 font-medium"
                                                  role="menuitem" tabindex="-1">
                                                  <?php echo csrf_field(); ?>
                                                  <button type="submit"
...
<?php /**PATH /var/www/todo_app/resources/views/tasks/index.blade.php ENDPATH**/ ?>